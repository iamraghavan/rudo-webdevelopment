...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		<?php do_action('fitness_blog_before_default_page'); ?>
			<div class="post-details-page">
						...
						<div class="previous-post">
							...
							<div class="postarrow">
								<a href="<?php echo get_permalink($prev_post->ID); ?>">
									<i class="fa fa-long-arrow-left"></i><?php echo esc_html_e( 'Previous Post', 'fitness-blog' ); ?>
								</a>
							</div>
					...
					<div class="next-post">
						...
						<div class="postarrow">
							<a href="<?php echo get_permalink($next_post->ID); ?>">
								<?php echo esc_html_e( 'Next Post', 'fitness-blog' ); ?><i class="fa fa-long-arrow-right"></i>
							</a>
						</div>
				...
				if (true === $s_post_el_is_on['show_recommend_posts']) :
					echo '<div class="related-post-wrapper">';
						fitness_blog_cats_related_post();
					echo '</div>';
				endif;
		...
		<?php do_action('fitness_blog_after_default_page'); ?>
	</main><!-- #main -->
</div><!-- #primary -->
<?php
get_footer();
