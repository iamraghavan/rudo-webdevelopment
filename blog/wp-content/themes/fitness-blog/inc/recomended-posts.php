...
function fitness_blog_cats_related_post() {
    $post_id = get_the_ID();
    $cat_ids = array();
    ...
    if($related_cats_post->have_posts()):
        ...
        <div class="recommended-post-section mt-5 mb-5">
			<h4 class="related-post-title text-center"><?php esc_html_e( 'Recommended Posts', 'fitness-blog' ); ?></h4>
        	<?php
        	echo '<div class="related-post-slider row">';
             while($related_cats_post->have_posts()): $related_cats_post->the_post(); ?>
                   <div class="<?php echo esc_attr($post_columns_class);?>">
                        <article id="post-<?php the_ID(); ?>" <?php post_class('fitness-blog-standard-post'); ?>>
                                ...
                                <div class="fitness-blog-standard-post__content-wrapper">
                                    ...
                                    <div class="fitness-blog-standard-post__blog-meta">
                                        ...
                                        if (true == $post_el_is_on['show_post_author']) :
                                            fitness_blog_posted_by( true );
                                        endif;
                                        if(true == $post_el_is_on['show_post_date']) :
                                            fitness_blog_posted_on();
                                        endif;
                                        ?>
                                    </div>
                                </div>
