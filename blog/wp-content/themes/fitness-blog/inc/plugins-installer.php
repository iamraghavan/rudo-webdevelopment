...
function fitness_blog_admin_enqueue_scripts(){
    wp_enqueue_style( 'fitness-blog-admin-css', get_template_directory_uri() . '/assets/css/admin.css', false );

	wp_enqueue_script( 'fitness-blog-admin-script', get_theme_file_uri('/js/admin.js'), array( 'jquery' ), '', true );
    wp_localize_script( 'fitness-blog-admin-script', 'fitness_blog_ajax_object',
        array( 'ajax_url' => admin_url( 'admin-ajax.php' ) )
    );
}
add_action( 'admin_enqueue_scripts', 'fitness_blog_admin_enqueue_scripts' );

add_action( 'wp_ajax_install_act_plugin', 'fitness_blog_admin_install_plugin' );

function fitness_blog_admin_install_plugin() {
