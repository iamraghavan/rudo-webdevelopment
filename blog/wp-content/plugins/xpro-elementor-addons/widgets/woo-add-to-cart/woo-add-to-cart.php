	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} form.cart .input-text.qty' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} form.cart .input-text.qty,{{WRAPPER}} .xpro-quantity-wrap .xpro-plus, {{WRAPPER}} form.cart .xpro-quantity-wrap .xpro-minus' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus'  => 'border-radius: 0 {{TOP}}{{UNIT}} {{TOP}}{{UNIT}} 0;',
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-minus' => 'border-radius: {{LEFT}}{{UNIT}} 0 0 {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-quantity-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);

		$this->add_control(
			'plus_minus_section_heading',
			array(
				'label'     => esc_html__( 'Increment', 'xpro-elementor-addons' ),
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-quantity-wrap i' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);

		$this->start_controls_tabs( 'quantity_btn_tabs' );

		$this->start_controls_tab(
			'quantity_btn_tabs_normal',
			array(
		...
		$this->add_control(
			'quantity_btn_tabs_normal_clr',
			array(
				'label'     => esc_html__( 'Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'selectors' => array(
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus,{{WRAPPER}} .xpro-quantity-wrap .xpro-minus' => 'color: {{VALUE}};',
				),
			)
		);

		$this->add_control(
			'quantity_btn_tabs_normal_bg_clr',
			array(
				'label'     => esc_html__( 'Background Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus,{{WRAPPER}} .xpro-quantity-wrap .xpro-minus' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			'quantity_btn_tabs_hover_clr',
			array(
				'label'     => esc_html__( 'Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'selectors' => array(
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus:hover,{{WRAPPER}} .xpro-quantity-wrap .xpro-minus:hover' => 'color: {{VALUE}}; fill: {{VALUE}};',
				),
			)
		);

		$this->add_control(
			'quantity_btn_tabs_hover_bg_clr',
			array(
				'label'     => esc_html__( 'Background Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus:hover,{{WRAPPER}} .xpro-quantity-wrap .xpro-minus:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		$this->add_control(
			'quantity_btn_tabs_hover_border_clr',
			array(
				'label'     => esc_html__( 'Background Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus:hover,{{WRAPPER}} .xpro-quantity-wrap .xpro-minus:hover' => 'border-color: {{VALUE}};',
				),
			)
		);
