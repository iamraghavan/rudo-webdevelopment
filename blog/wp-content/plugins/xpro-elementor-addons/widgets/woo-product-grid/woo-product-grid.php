...
class Woo_Product_Grid extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'qv_quantity_btn_heading',
			array(
				'label'     => __( 'Quantity Buttons', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->start_controls_tabs(
			'qv_quantity_btn_style_tabs'
		);

		$this->start_controls_tab(
			'qv_quantity_btn_normal_tab',
			array(
				'label' => __( 'Normal', 'xpro-elementor-addons' ),
			)
		);
		...
		$this->add_control(
			'qv_quantity_btn_color',
			array(
				'label'     => __( 'Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .xpro-minus, {{WRAPPER}} .xpro-qv-main-wrapper .xpro-plus' => 'color: {{VALUE}} !important;',
				),
			)
		);

		$this->add_control(
			'qv_quantity_btn_bg_color',
			array(
				'label'     => __( 'Background Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .xpro-minus,{{WRAPPER}} .xpro-qv-main-wrapper .xpro-plus' => 'background-color: {{VALUE}} !important;',
				),
			)
		);
		...
		$this->start_controls_tab(
			'qv_quantity_btn_hover_tab_style',
			array(
				'label' => __( 'Hover', 'xpro-elementor-addons' ),
			)
		);
		...
		$this->add_control(
			'qv_quantity_btn_hcolor',
			array(
				'label'     => __( 'Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .xpro-minus:hover,{{WRAPPER}} .xpro-qv-main-wrapper .xpro-plus:hover' => 'color: {{VALUE}} !important;',
				),
			)
		);

		$this->add_control(
			'qv_quantity_btn_bg_hcolor',
			array(
				'label'     => __( 'Background Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .xpro-minus:hover,{{WRAPPER}} .xpro-qv-main-wrapper .xpro-plus:hover' => 'background-color: {{VALUE}} !important;',
				),
			)
		);

		$this->add_control(
			'qv_quantity_btn_border_hcolor',
			array(
				'label'     => __( 'Border Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .xpro-minus:hover,{{WRAPPER}} .xpro-qv-main-wrapper .xpro-plus:hover' => 'border-color: {{VALUE}} !important;',
				),
			)
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			array(
				'name'        => 'qv_quantity_btn_border',
				'label'       => __( 'Border', 'xpro-elementor-addons' ),
				'placeholder' => '1px',
				'selector'    => '{{WRAPPER}} .xpro-qv-main-wrapper .xpro-minus,{{WRAPPER}} .xpro-qv-main-wrapper .xpro-plus',
			)
		);

		$this->add_control(
			'qv_quantity_btn_border_radius',
			array(
				'label'      => __( 'Border Radius', 'xpro-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .xpro-minus,{{WRAPPER}} .xpro-qv-main-wrapper .xpro-plus' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
